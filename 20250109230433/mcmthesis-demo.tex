...
The adapted model provided three strategic recommendations: \textbf{economy-first}, \textbf{ecology-first} and 
\textbf{balanced} with detailed values of decision-making. The result also indicates that the \textbf{government
investment} become more important compared to Juneau due to the local policies on Franz Josef Glacier.
